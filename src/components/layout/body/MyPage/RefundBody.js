...
export default function RefundBody() {
  ...
  return (
    ...
    >
      <TableContainer>
        <Table sx={{border:"1px solid", borderColor:"#e0e0e0", borderRadius:"4px", width: "70vw", margin: "auto" }}>
          <TableHead>
            <TableRow>
              <TableCell style={{ width: "25%", textAlign: "center", fontWeight:"bold", fontSize:"15px" }}>상품명(옵션)</TableCell>
              <TableCell style={{ width: "25%", textAlign: "center", fontWeight:"bold", fontSize:"15px" }}>신청일자</TableCell>
              <TableCell style={{ width: "25%", textAlign: "center", fontWeight:"bold", fontSize:"15px" }}>구분</TableCell>
              <TableCell style={{ width: "25%", textAlign: "center", fontWeight:"bold", fontSize:"15px" }}>상태</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {rows.length > 0
              ? rows.map((row, index) => (
                  <StyledTableRow key={index}>
                    <TableCell component="th" scope="row" style={{ width: "25%", alignItems: "center" }}>
                      <ProductInfo>
                    ...
                    <TableCell style={{ width: "25%", textAlign: "center" }}>{row.RefundDate}</TableCell>
                    <TableCell style={{ width: "25%", textAlign: "center" }}>{row.type}</TableCell>
                    <TableCell style={{ width: "25%", textAlign: "center" }}>{row.state}</TableCell>
                  </StyledTableRow>
                ))
              : [...Array(4)].map((_, index) => (
