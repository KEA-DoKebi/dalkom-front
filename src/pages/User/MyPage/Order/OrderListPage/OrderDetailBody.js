...
const OrderDetailBody = () => {
  ...
  return (
    <Box>
      <Typography sx={{ fontSize: "40px", mb: 3 }}>주문 상세 내역</Typography>
          ...
          >
            <thead>
              <tr style={{ height: "50px", borderBottom: "1px solid black" }}>
                <td style={{ width: "30%", textAlign: "center" }}>상품 정보</td>
                <td style={{ width: "10%", textAlign: "center" }}>수량</td>
                <td style={{ width: "20%", textAlign: "center" }}>상품 금액</td>
                <td style={{ width: "20%", textAlign: "center" }}>배송 상태</td>
                <td style={{ width: "20%", textAlign: "center" }}>후기 작성</td>
              </tr>
            </thead>
            <tbody>
            ...
            <Table sx={{ width: "100%", margin: "auto" }}>
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell style={{ width: "80%", textAlign: "left" }}>
                    <Typography>{orderDate.substring(0, 10)}</Typography>
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell
