    ...
    <Body>
      ...
      <Container>
        ...
        <TextS2>
          ...
          회원가입비나 월회비, 연회비 등 어떠한 비용도 청구하지 않는 100%
          무료입니다.
        </TextS2>
        ...
        <TextS2>
          - DalKom.Shop은 마일리지를 통한 결제방법을 제공하고 있습니다.
        </TextS2>
        ...
        <TextS2>
          - DalKom.Shop은 CJ대한통운 택배를 이용하고 있으며, 배송 관련 사항들은
          택배사 원칙에 따라 운영되고 있습니다.{"\n"}- 고객님꼐서 마일리지를
          충전하여 구매하신 경우에는 입금확인이 된 날로부터 2~3일 이내에(최장
          7일이내) 입력하신 {"\n"}배송지로 부터 주문상품이 도착하게 됩니다.
          주문하신 상품 또는 배송지에 따라 배송기간이 상이할 수 있씁니다.
        </TextS2>
        <TextL2>2. 주문확인 및 배송조회</TextL2>
        <TextS2>
          - DalKom.Shop 공식 홈페이지에서 주문시 메인페이지 -&gt; 주문배송을
          통해 주문확인 및 배송조회가 가능합니다.
        </TextS2>
        ...
        <TextS2>
          ...
          후 주문취소는 DalKom.Shop 고객센터 또는 1:1 문의 게시판으로 요청
          바랍니다.
        </TextS2>
        <TextL2>2. 교환 / 반품</TextL2>
        <TextS2>
          - 교환/반품 요청 기한은 상품 수령 후 최대 14일 이내이며 미개봉 상품에
          한하여 가능합니다.(상품에 하자가 있는 경우 수령 후 7일).{"\n"}-
          변심으로 인한 교환/반품일 경우 왕복 택배비는 고객 부담이며, 반드시
          저희 고객센터를 통해 접수 후 상담팀에 안내에 따라 반품을 진행할 수
          있습니다
        </TextS2>
      </Container>
    </Body>
