    ...
    <Paper sx={{ display: "flex", height: "100vh" }}>
      ...
      >
        ...
        >
          ...
          <Pagination count={10} />
          {/* 공지사항 작성 모달  */}
          <Dialog onClose={handleWriteOpenModal} open={writeModalOpen} maxWidth={false}>
            <DialogTitle> 
              <InputBoxM
              color="neutral"
              placeholder="Text"
          ...
          {/* 공지사항 보기 모달 */}
          <Dialog onClose={handleLookOpenModal} open={lookModalOpen} maxWidth={false}>
            <DialogContent style={{ width: 900, height: 600 }}>
              <div>
                ...
                <Grid>
                  작성일시 : 2024-01-22  작성자 라이언
                </Grid>
                
                <Typography style={{marginTop:"5%"}}>
                안녕하세요. 소중한 고객 여러분께 알려드리는 공지사항이 있습니다. 최근의 업데이트로 인해 당사의 서비스가 더욱 원활하고 효율적으로 운영될 수 있도록 노력하고 있습니다. 새롭게 추가된 기능들과 향상된 사용자 경험을 통해 더욱 편리한 서비스를 제공하고자 합니다.
                <br/>
                <br/>
              ...
              >
                <AdminButton autoFocus onClick={handleLookCloseModal} style={{marginRight:"5%"}}>
                  수정
                </AdminButton>
